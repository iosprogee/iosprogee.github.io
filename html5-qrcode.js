...
var Html5QrcodeScanner = function() {
    ...
    return _createClass(a, [{
        ...
        value: function() {
            ...
            if (this.html5Qrcode)
                return new Promise(function(d, e) {
                    a.html5Qrcode._isScanning() && a.html5Qrcode.stop().then(function() {
                        b.html5Qrcode.clear(),
                        c(),
                        d()
                    })["catch"](function(a) {
        ...
        value: function(a) {
            ...
            /*c.innerHTML = "QR Scanner", */
            c.innerHTML = '<span class="material-icons x-small">qr_code</span>',
            b.appendChild(c);
            var d = document.createElement("span");
            d.id = this.__getStatusSpanId(),
            d.style.float = "right",
            d.style.padding = "4px 4px",
            d.style.margin = "1px 4px 1px 10px",
            d.style.fontSize = "xx-small",
